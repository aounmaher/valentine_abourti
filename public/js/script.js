...
function changeLanguage() {
    ...
    if (language === "french") {
        questionHeading.textContent = "Abourti,Tu veux être ma valentine?";
    } else if (language === "thai") {
        questionHeading.textContent = "คืนดีกับเราได้อ่ะป่าว?";
    } else {
        questionHeading.textContent = "Abourti,Will you be my valentine?";
    }
    ...
    if (language === "french") {
        successMessage.textContent = "yaaa rouhiiiiiiiiiiiiiiiiiiiiiii  à bientôt :3";
    } else if (language === "thai") {
        successMessage.textContent = "ฮูเร่ คืนดีกันแล้วน้า :3";
    } else {
        successMessage.textContent = "yaaa rouhiiiiiiiiiiiiiiiiiiiiiii seeee you sooon :3";
    }
}
